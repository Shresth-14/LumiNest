  ...
  <span className="text-sm font-medium bg-linear-to-r from-gray-400 to-gray-400 
    ...
    Back to Home
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-400 text-sm">Join 
        ...
        <form className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-linear-to-r from-[#e8d9b0] to-[#c4a96a] hover:from-[#f3e6c1] hover:to-[#d9b877] text-black font-semibold py-3 rounded-lg transition-all duration-200 transform hover:scale-105 hover:shadow-lg flex items-center justify-center gap-2"
          >
        ...
        <div className="mt-4 text-center text-gray-400 text-sm">
          ...
          <Link to="/login" className="bg-linear-to-r from-[#e8d9b0] to-[#c4a96a] bg-clip-text text-transparent font-medium hover:opacity-80">
            Log in
          </Link>
        </div>
      </div>
