...
const filteredSpaces = allSpaces.filter((space) => {
  ...
  const typeOptions = ['All', 'Office', 'Retail', 'Co-Working', 'Warehouse', 'Restaurant'];
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white pt-20">
      <div className="max-w-6xl mx-auto px-4 py-8 text-center">
        ...
        <span className="text-cyan-400 text-md tracking-wide">{filteredSpaces.length}</span>
          ...
          <div className="relative w-44">
            ...
            >
              {typeOptions.map(option => (
                <option key={option} value={option} className="bg-neutral-900 text-gray-300">{option}</option>
              ))}
            </select>
        ...
        {filteredSpaces.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {filteredSpaces.map((space) => (
              ...
              >
                <img src={space.image} alt={space.title} className="h-48 w-full object-cover" />
                <div className="p-4">
                  ...
                  <div className="flex flex-wrap gap-1 mb-3 text-xs text-gray-400">
                    <span className="px-2 py-0.5 bg-neutral-800 rounded">{space.type}</span>
