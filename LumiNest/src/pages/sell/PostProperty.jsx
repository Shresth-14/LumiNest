      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-3 py-1.5 bg-neutral-800/40 border border-neutral-700/40 rounded-md text-sm text-gray-200 placeholder:text-gray-500 outline-none focus:border-blue-500/50 transition"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full px-3 py-1.5 bg-neutral-800/40 border border-neutral-700/40 rounded-md text-sm text-gray-200 outline-none focus:border-blue-500/50 transition cursor-pointer"
                >
          ...
          <div className="bg-neutral-900/30 rounded-lg p-4 border border-neutral-800/30">
            ...
            <div className="border-2 border-dashed border-neutral-700/40 rounded-lg p-4 text-center hover:border-blue-500/50 transition-all cursor-pointer">
          ...
          <div className="flex gap-2.5 pt-1">
            ...
            <button
              type="submit"
              className="flex-1 px-4 py-2 bg-linear-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-600 text-white text-sm font-semibold rounded-md transition-all shadow-lg shadow-blue-500/20"
            >
              Submit Property
            </button>
          </div>
